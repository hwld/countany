# Migration `20201129002520`

This migration has been generated by hwld at 11/29/2020, 9:25:20 AM.
...
ALTER TABLE "public"."Counter" ADD FOREIGN KEY("userId")REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE
```
...
+// }
+
+// migrateするときにdotenvで.env.devと.env.prodを切り替える
+datasource db {
